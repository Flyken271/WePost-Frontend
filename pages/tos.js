...
const Termsofservice = () => {
  return (
    <div id="tos">
      <h3>
        Website defined by, Website founder, Website staff and its personel
      </h3>
      <h2>Use of.</h2>
      <p>
        By Website discretion, whether freelancer/user has or will be
        completing/completed work provided by or from a list/post/offer by or
        from an account listed as business deemed to be at fault to either
        partied or both. Freelancer/user must complete the task listed within
        the claimed post in order to receive the reward listed on said post,
        deemed by the Website the reward will be released back to the post's
        owner if the post's task is not met. Business account holders must make
        sure their post is deemed tangible and legible for freelance/user
        parties, the post must remain in English and must retain all of the
        required information for the task to be complete. Business account
        holders will need to specify payment method before posting, funds will
        be taken out of the Business account holder's account to be witheld
        until the post has been completed or requested removed by account
        holder. There is a 3% fee included in initial witholding of funds that
        is non-refundable in any circumstances. Website witholds the right to
        refuse service to Freelancer/user and or Business accounts in any manor
        deemed so by the Website, this Website may or may not terminate
        Freelance/user and or Business accounts for any reason not limited by
        but including the following: Fake account, Fraud, No-intent to confer,
        any other reason deemed so by Website.
      </p>

      <h1>Terms &amp; Conditions</h1>
      <p>
        <strong>Last updated September 05, 2020</strong>
      </p>
      <p>
      ...
      <p>
        ...
        ”) and <a href="https://WePost.xyz">https://WePost.xyz</a> (“
        <strong>we</strong>”, “<strong>us</strong>”, or “<strong>our</strong>”),
        concerning your access to and use of the{" "}
        <a href="https://WePost.xyz">https://WePost.xyz</a> website as well as
      ...
      <p>
        ...
        Policy:{" "}
        <strong>
          <a href="https://WePost.xyz/privacy-policy/">
            https://WePost.xyz/privacy-policy/
          </a>
        </strong>
        ...
        hosted in Pennsylvania. If you access the Site from any other region of
        ...
        Pennsylvania, then through your continued use of the Site, you are
        transferring your data to Pennsylvania, and you agree to have your data
        transferred to and processed in Pennsylvania.
      </p>
      <p>
      ...
      <p>
        ...
        Pennsylvania. <a href="https://WePost.xyz">https://WePost.xyz</a> and
        yourself irrevocably consent that the courts of Pennsylvania shall have
      ...
      <p>
        ...
        Pennsylvania courts. <a href="https://WePost.xyz">https://WePost.xyz</a>{" "}
        shall also maintain the right to bring proceedings as to the substance
        of the matter in the courts of the country where you reside or, if these
      ...
      <p>
        <strong>
          <a href="https://WePost.xyz">https://WePost.xyz</a>
        </strong>
      </p>
      <p>
        <a href="mailto:info@WePost.xyz">info@WePost.xyz</a>
      </p>
    </div>
  );
};
